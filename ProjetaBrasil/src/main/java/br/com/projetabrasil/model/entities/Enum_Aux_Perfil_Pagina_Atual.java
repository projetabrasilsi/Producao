...
public enum Enum_Aux_Perfil_Pagina_Atual {
	...
	PAGINAACHEIPET("PAGINAACHEIPET","PAGPET",43,null,Enum_Aux_Perfil_Pessoa.OUTROS,Enum_Aux_Perfil_Pessoa.OUTROS ,true,true,"acheipet.xhtml","Pagina Achei Pet"),
	PAGINATRANSFERENCIASQRCODE("PAGINATRANSFERENCIASQRCODE","PTRANS",44,null,Enum_Aux_Perfil_Pessoa.OUTROS,Enum_Aux_Perfil_Pessoa.OUTROS ,true,true,"transferenciaqrcode.xhtml","Pagina de transferencia de QRCode"),
	PAGINALOGISTICA("PAGINALOGISTICA","PLOG",45,null,Enum_Aux_Perfil_Pessoa.LOGISTICA,Enum_Aux_Perfil_Pessoa.LOGISTICA,false,true,"pessoas.xhtml", "logistica"),
	PAGINAFUNCIONARIOS("PAGINAFUNCIONARIOS","PFUNC",46,null,Enum_Aux_Perfil_Pessoa.FUNCIONARIOS,Enum_Aux_Perfil_Pessoa.REVENDEDORES,false,true,"pessoas.xhtml", "logistica"),
	PAGINAVINCULARQRCODE("PAGINAVINCULARQRCODE","PVINC",47,null,Enum_Aux_Perfil_Pessoa.OUTROS,Enum_Aux_Perfil_Pessoa.OUTROS ,true,true,"transferenciaqrcode.xhtml","QRCodes para vínculo"),
